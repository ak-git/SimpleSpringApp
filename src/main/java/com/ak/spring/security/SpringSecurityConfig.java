...
public class SpringSecurityConfig {
  ...
  public SecurityFilterChain filterChain(@NonNull HttpSecurity http) throws Exception {
    http
        ...
        .and()
        .authorizeRequests()
        .antMatchers(HttpMethod.GET, "/controller/persons/").hasRole(Person.Role.ADMIN.name())
        .antMatchers(HttpMethod.GET, PERSON_PATTERN).permitAll()
        .antMatchers(HttpMethod.PUT, PERSON_PATTERN).permitAll()
        ...
        .antMatchers(HttpMethod.GET, PLAYER_USER_PATTERN).hasRole(Person.Role.USER.name())
        .antMatchers(HttpMethod.POST, PLAYER_USER_PATTERN).hasRole(Person.Role.USER.name())
        .antMatchers(HttpMethod.PUT, PLAYER_USER_PATTERN).hasRole(Person.Role.USER.name())
