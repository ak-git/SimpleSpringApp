...
class DataGeneratorTest {
  @Test
  void generatePersons(@Autowired @Qualifier("Persons") CommandLineRunner generatePersons) {
    check(generatePersons);
  }

  @Test
  void generatePlayers(@Autowired @Qualifier("PLayers") CommandLineRunner generatePlayers) {
    check(generatePlayers);
  }

  private static void check(CommandLineRunner runner) {
